...
public interface IsiLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#cmdsesenao}.
	 * @param ctx the parse tree
	 */
	void enterCmdsesenao(IsiLangParser.CmdsesenaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdsesenao}.
	 * @param ctx the parse tree
	 */
	void exitCmdsesenao(IsiLangParser.CmdsesenaoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#op}.
	 * @param ctx the parse tree
	 */
	void enterOp(IsiLangParser.OpContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#op}.
	 * @param ctx the parse tree
	 */
	void exitOp(IsiLangParser.OpContext ctx);
}